...
Build and run the analysis environment in a container (includes R for Figure 2–4 Rmd and Python for notebooks and scripts).
...
**Run a shell with the repo and data mounted:**
